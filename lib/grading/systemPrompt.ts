...
- "ways_to_improve": give 2-3 ordered actions the student can apply to the next answer. Put each action in its own short paragraph, separated by a blank line. Explain why each action matters, and suggest 1-2 stronger alternative lines for the most important weak thesis, transition, supporting claim, or conclusion when the submission contains one. Preserve the student's intended position and voice rather than replacing it with a generic model answer. Do not repeat the remarks paragraph.
