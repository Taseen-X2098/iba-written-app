...
- "ways_to_improve": one substantive paragraph of 3-5 sentences. Give 2-3 ordered actions the student can apply to the next answer, explain why each action matters, and suggest 1-2 stronger alternative lines for the most important weak thesis, transition, supporting claim, or conclusion when the submission contains one. Preserve the student's intended position and voice rather than replacing it with a generic model answer. Do not repeat the remarks paragraph.
