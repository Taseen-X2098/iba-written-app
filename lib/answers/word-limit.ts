export const WORD_LIMIT_BANDS = [
  ...
  { maximumMarks: 8, wordLimit: 140 },
  { maximumMarks: 10, wordLimit: 180 },
  { maximumMarks: 12, wordLimit: 220 },
  { maximumMarks: 13, wordLimit: 240 },
  { maximumMarks: Number.POSITIVE_INFINITY, wordLimit: 270 },
] as const;
